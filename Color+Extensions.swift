...
extension Color {
    ...
    static let customSecondaryBackgroundColor = Color("customSecondaryBackgroundColor")
    static let customButtonBackgroundColor = Color("customButtonBackgroundColor")
}
